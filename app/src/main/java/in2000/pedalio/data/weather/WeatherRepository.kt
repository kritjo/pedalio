...
abstract class WeatherRepository {
     ...
     * @param timeDelta in minutes
     */
    abstract suspend fun getPrecipitationRate(
        lat: Double,
        lon: Double,
        timeDelta: Int = 0
    ): Double?
     ...
     * @param timeDelta in minutes
     */
    abstract suspend fun getPrecipitation(
        lat: Double,
        lon: Double,
        timeDelta: Int = 0
    ): Double?
     ...
     * @param timeDelta in minutes
     */
    abstract suspend fun getRelativeHumidity(
        lat: Double,
        lon: Double,
        timeDelta: Int = 0
    ): Double?
     ...
     * @param timeDelta in minutes
     */
    abstract suspend fun getWindDirection(
        lat: Double,
        lon: Double,
        timeDelta: Int = 0
    ): Double?
     ...
     * @param timeDelta in minutes
     */
    abstract suspend fun getWindSpeed(
        lat: Double,
        lon: Double,
        timeDelta: Int = 0
    ): Double?
     ...
     * @param timeDelta in minutes
     */
    abstract suspend fun getGustSpeed(
        lat: Double,
        lon: Double,
        timeDelta: Int = 0
    ): Double?
     ...
     */
    abstract suspend fun radarCoverage(
        lat: Double,
        lon: Double
    ): Boolean
     ...
     */
    abstract suspend fun getWeatherIcon(
        lat: Double,
        lon: Double,
        timeDelta: Int
    ): String?
